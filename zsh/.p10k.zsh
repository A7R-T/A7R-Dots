# Generated by Powerlevel10k configuration wizard on 2025-12-08 at 23:34 EET.
...
# Custom colors to match kitty theme
typeset -g POWERLEVEL9K_DIR_FOREGROUND=110  # Light blue (matches #8fb8d5)
typeset -g POWERLEVEL9K_VCS_FOREGROUND=73    # Light cyan (matches #6DA6CE)
typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=76  # Light green
typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=196  # Light red
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=66  # Cyan
typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=245  # Light gray
